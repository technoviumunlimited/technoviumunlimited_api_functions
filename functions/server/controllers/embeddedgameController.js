...
exports.getGame = async (req, res, next) => {
  ...
  if(game[0].game_engine == "godot"){

    const godot_index_js = await storage
      .bucket('technoviumunlimited.appspot.com')
      .file('games/' + paramID + "/index.js")
      .getSignedUrl(options);
    
    const godot_index_pck = await storage
      .bucket('technoviumunlimited.appspot.com')
      .file('games/' + paramID + "/index.pck")
      .getSignedUrl(options);

    const godot_wasm = await storage
    .bucket('technoviumunlimited.appspot.com')
    .file('games/' + paramID + "/index.wasm")
    .getSignedUrl(options);
    ...
    <iframe id="fullscreenIframe" src="https://api.technoviumunlimited.nl/games/Ag7KtmdKNIG0va7bi1ne/index.html"></iframe>
  ...
  if(game[0].game_engine == "unity"){
      /**** HIER is code for Unity */
      try {
